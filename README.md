...
> http://uliagareeva.site/auth
> 
> admin: http://uliagareeva.site/admin/
> 
...
## **Telegram bot:**
 ...
 > Bot telegram https://t.me/my2_todolist_bot
...
> create .env file 
> 
**you can copy the default variables from .env_example**

**4. Launch database from deploy folder**

> cd deploy_locally
> 
>docker compose --env-file .env_locally -f docker-compose_db.yaml up -d
> 
...
**1. Create .docker_env file in deploy_locally folder:**
...
> cd deploy_locally
> 
>docker compose --env-file .docker_env -f docker-compose.yaml up -d
>
...
env variables: deploy/.env_example
